<template>
    <div class="knowledeg_wrap">
        <div class="knowledge_bgc">
            <img src="~/assets/banner/actionbgc.png" alt="" />
            <div class="tabbar">
                <li
                ...
                >
                    <span :class="{ checked: index == checkTabItem }">{{
                        item.label
                    }}</span>
                </li>
            </div>
...
export default {
            ...
            tabNav: [
                {
                    ...
                    value: 1,
                    checked: true,
                    artType: "antiNonPublicity"
                },
                {
                    label: "反洗钱",
                    value: 2,
                    checked: false,
                    artType: "antiMoneyLaunder"
                },
                {
                    label: "适当性管理",
                    value: 3,
                    checked: false,
                    artType: "appropriatenessManagement"
                },
                {
                    label: "典型案例",
                    value: 4,
                    checked: false,
                    artType: "typicalCases"
                },
                {
                    label: "投资者保护",
                    value: 5,
                    checked: false,
                    artType: "investorProtection"
                },
                {
                    label: "投教活动",
                    value: 6,
                    checked: false,
                    artType: "teachingActivities"
                }
            ],
            tableList: [],
            activeTab: "",
    ...
    methods: {
        getVisit(params) {
            ...
            _paq.push(["setCustomUrl", `action/${params.id}`]);
    ...
    mounted() {
        ...
        if (paramsId) {
            ...
            if (checkItemTab) {
                this.getArtFn({
                    pageNo: 1,
                    artType: this.tabNav[checkItemTab].artType
                });
